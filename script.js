...
const USERS = [
    { username: "codigos", password: "3602", expiresAt: new Date("2026-02-03") },
    { username: "usuario448", password: "4448", expiresAt: new Date("2026-01-10") },
    { username: "usuario507", password: "3012", expiresAt: new Date("2026-01-12") },
    { username: "code991", password: "6398", expiresAt: new Date("2026-01-16") },
    { username: "exagono", password: "4108", expiresAt: new Date("2025-12-01") },
    { username: "codigo109", password: "1234", expiresAt: new Date("2026-01-05") },
    { username: "dinrrix1", password: "2219", expiresAt: new Date("2026-01-15") },
    { username: "tiger26", password: "1234", expiresAt: new Date("2026-02-28") },
    { username: "katzetech", password: "1234", expiresAt: new Date("2026-01-15") },
    { username: "Diego1", password: "6235", expiresAt: new Date("2026-01-18") },
    { username: "dragon1", password: "1234", expiresAt: new Date("2026-01-30") },
    { username: "asd", password: "\\t2323beat2323", expiresAt: new Date("2026-01-23") },
    { username: "camilo2", password: "1223", expiresAt: new Date("2026-01-23") }
];
