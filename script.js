...
const USERS = [
    ...
    { username: "usuario79", password: "6679", expiresAt: new Date("2025-11-07") },
    { username: "usuario448", password: "4448", expiresAt: new Date("2025-11-07") },
    { username: "admin", password: "1090467098", expiresAt: new Date("2026-09-29") }
];
